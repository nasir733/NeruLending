...
urlpatterns = [
    ...
    url('financing-plan-1/', login_required(FinancingPlan1View.as_view(), login_url='/user/login'),
        name='financing_plan_1'),
    url('financing-plan-2/', login_required(FinancingPlan2View.as_view(), login_url='/user/login'),
        name='financing_plan_2'),
    url('financing-plan-3/', login_required(FinancingPlan3View.as_view(), login_url='/user/login'),
        name='financing_plan_3'),
    url('financing-plan-6/', login_required(FinancingPlan6View.as_view(), login_url='/user/login'),
        name='financing_plan_6'),
    url('financing-plan-7/', login_required(FinancingPlan7View.as_view(), login_url='/user/login'),
        name='financing_plan_7'),
    url('financing-plan-8/', login_required(FinancingPlan8View.as_view(), login_url='/user/login'),
        name='financing_plan_8'),
    url('financing-plan-10/', login_required(FinancingPlan10View.as_view(), login_url='/user/login'),
        name='financing_plan_10'),
    url('financing-plan-12/', login_required(FinancingPlan12View.as_view(), login_url='/user/login'),
        name='financing_plan_12'),
    url('financing-plan-15/', login_required(FinancingPlan15View.as_view(), login_url='/user/login'),
        name='financing_plan_15'),
    ...
    url('business-plan-1/', login_required(BusinessPlan1View.as_view(), login_url='/user/login'),
        name='business_plan_1'),
    url('business-plan-2/', login_required(BusinessPlan2View.as_view(), login_url='/user/login'),
        name='business_plan_2'),
    url('business-plan-3/', login_required(BusinessPlan3View.as_view(), login_url='/user/login'),
        name='business_plan_3'),
    ...
    url('invoice-factoring/', login_required(InvoiceFactoringView.as_view(), login_url='/user/login'),
        name='invoice-factoring'),
    url('invoice-financings/', login_required(InvoiceFinancingView.as_view(), login_url='/user/login'),
    ...
    url('business-credit-monitoring/',
        login_required(BusinessCreditMonitoringSingUp.as_view(), login_url='/user/login'),
    ...
    url('credit-repair-1/', login_required(CreditRepairPlan1View.as_view(), login_url='/user/login'),
        name='credit_repair_1'),
    url('credit-repair-2/', login_required(CreditRepairPlan2View.as_view(), login_url='/user/login'),
        name='credit_repair_2'),
    url('credit-repair-3/', login_required(CreditRepairPlan3View.as_view(), login_url='/user/login'),
        name='credit_repair_3'),
    url('credit-repair-4/', login_required(CreditRepairPlan4View.as_view(), login_url='/user/login'),
        name='credit_repair_4'),
    url('credit-repair-5/', login_required(CreditRepairPlan5View.as_view(), login_url='/user/login'),
        name='credit_repair_5'),
    url('credit-repair-6/', login_required(CreditRepairPlan6View.as_view(), login_url='/user/login'),
        name='credit_repair_6'),
    url('credit-repair-7/', login_required(CreditRepairPlan7View.as_view(), login_url='/user/login'),
        name='credit_repair_7'),
    url('credit-repair-8/', login_required(CreditRepairPlan8View.as_view(), login_url='/user/login'),
        name='credit_repair_8'),
    url('credit-repair-9/', login_required(CreditRepairPlan9View.as_view(), login_url='/user/login'),
        name='credit_repair_9'),
    url('credit-repair-10/', login_required(CreditRepairPlan10View.as_view(), login_url='/user/login'),
        name='credit_repair_10'),
    url('credit-repair-11/', login_required(CreditRepairPlan11View.as_view(), login_url='/user/login'),
        name='credit_repair_11'),
    url('credit-repair-12/', login_required(CreditRepairPlan12View.as_view(), login_url='/user/login'),
        name='credit_repair_12'),
    url('credit-repair-13/', login_required(CreditRepairPlan13View.as_view(), login_url='/user/login'),
        name='credit_repair_13'),
    url('credit-repair-14/', login_required(CreditRepairPlan14View.as_view(), login_url='/user/login'),
        name='credit_repair_14'),
    url('credit-repair-15/', login_required(CreditRepairPlan15View.as_view(), login_url='/user/login'),
        name='credit_repair_15'),
    url('credit-repair-16/', login_required(CreditRepairPlan16View.as_view(), login_url='/user/login'),
        name='credit_repair_16'),
    url('credit-repair-17/', login_required(CreditRepairPlan17View.as_view(), login_url='/user/login'),
        name='credit_repair_17'),
]
