...
urlpatterns = [
    url('home', login_required(HomeView.as_view(), login_url='/user/login'),
        name='home'),
    url('1', login_required(OneView.as_view(), login_url='/user/login'),
        name='1'),
    ...
    url('11', login_required(ElevenView.as_view(), login_url='/user/login'),
        name='11'),
    url('12', login_required(TwelveView.as_view(), login_url='/user/login'),
        name='12'),
