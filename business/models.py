...
class BusinessCreditCard(ModelMixin, models.Model):
    ...
    cc_name = models.CharField(null=True,max_length=50)
    min_credit_score = models.CharField(null=True,max_length=50)
    credit_bureau = models.CharField(null=True,max_length=50)
    debt_ratio = models.CharField(null=True,max_length=50)
    bankruptcy = models.CharField(null=True,max_length=50)
    credit_data = models.CharField(null=True,max_length=50)
    apr = models.CharField(null=True,max_length=50)
    strategy = models.CharField(null=True,max_length=500)
    max_inquiries = models.CharField(null=True,max_length=50)
    url = models.CharField(blank=True, max_length=100)
    created_at = models.DateTimeField(null=True, blank=True)
    updated_at = models.DateTimeField(null=True, blank=True)
...
class NoCreditCheckLoans(ModelMixin, models.Model):
    ...
    lender_name = models.CharField(null=True, max_length=50)
