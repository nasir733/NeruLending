...
urlpatterns = [
    ...
    url('enternewleads', login_required(EnterNewLeadsView.as_view(), login_url='/user/login'),
        name='enternewleads'),
        url('marketingroi', login_required(MarketingRoi.as_view(), login_url='/user/login'),
            name='marketingroi'),
    ...
    url('buywhitelabelbusinesspackage', login_required(BuyWhitelabelBusinessPackageView.as_view(), login_url='/user/login'),
    ...
    url('viewwhitelabelbusinesspackage', login_required(ViewWhiteLabelBusinessPackageView.as_view(), login_url='/user/login'),
